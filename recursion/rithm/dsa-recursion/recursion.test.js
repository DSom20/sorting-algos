...
describe("everyOtherReverse", function() {
  it("returns a string with every other character in the input, reversed", function() {
    expect(everyOtherReverse("hello")).toBe("olh");
    expect(everyOtherReverse("banana stand")).toBe("nt nnb");
    expect(everyOtherReverse("ddoouubbllee")).toBe("elbuod");
    expect(everyOtherReverse("hi")).toBe("h");
    expect(everyOtherReverse("z")).toBe("z");
  });
});
